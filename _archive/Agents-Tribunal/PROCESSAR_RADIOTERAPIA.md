# 🎯 Comando Completo: Processar PDFs de Radioterapia
...
1. **MCP configurado no Cursor:**
   - Settings → Features → MCP
   - `Biomed-Slide-Agent` deve estar ativo (sem erro)

2. **PDFs existem:**
   - Verifica se os caminhos dos PDFs estão corretos

3. **Dependências instaladas:**
   - O servidor MCP deve estar a funcionar

---

## 📊 O Que Esperar

O notebook final terá:
- ✅ Todas as imagens dos slides em alta resolução
- ✅ Análises detalhadas do Tribunal
- ✅ Explicações profundas de física e cálculos
- ✅ Exercícios resolvidos passo a passo
- ✅ Código Python executável
- ✅ Comentários inline explicando tudo
- ✅ Referências bibliográficas
- ✅ Informações extras sobre cada termo
- ✅ Correlações entre conceitos
- ✅ Muito mais completo que os slides originais
